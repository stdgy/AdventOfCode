...
def count_locations_within_reach(steps, shortest_path_grid):
    count = 0
    for row in shortest_path_grid:
        for col in row:
            if col is not None and col <= steps:
                count = count + 1
    return count
...
if __name__ == '__main__':
    ...
    locs_within_50_steps = count_locations_within_reach(50, shortest_path_grid)
    print('You can reach {} locations by taking at most 50 steps'.format(locs_within_50_steps))